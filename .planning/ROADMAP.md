...
|-------|------|----------|--------|
| 1 | Photo Saving | Yes | Pending |
| 2 | Analysis Pipeline | Yes | Pending |
| 3 | Analysis UI — Feature Scores | No | Pending |
| 4 | Analysis UI — Performance & Layout | Yes | Pending |
| 5 | Shop & Coach UI | No | Pending |
