    ...
    <>
      ...
      <Section title="Privacy Policy" subtitle="Last Updated: November 29, 2025">
        <div className="prose max-w-4xl mx-auto text-secondary">
          ...
          <p>
            Welcome to SheMax ("we," "our," or "us"). We respect your privacy and are committed to protecting your personal data. 
          ...
          <h3>9. Contact Us</h3>
          <p>
            If you have questions about this Privacy Policy or our face data practices, contact us at <a href="mailto:support@shemax.app">support@shemax.app</a>.
          </p>
        </div>
      </Section>
