...
export async function sendEmail({
  ...
  try {
    const data = await resend.emails.send({
      from: 'SheMax <noreply@shemax.app>',
      to,
      subject,
      html,
    });
...
export async function sendSubscriptionConfirmation(
  ...
  const html = `
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <p>Your subscription to <strong>SheMax ${tier}</strong> is confirmed.</p>
          <div class="highlight">
          ...
          <p><a href="https://shemax.app/dashboard" class="cta">Go to Dashboard</a></p>
        </div>
        <div class="footer">
          <p>SheMax - Be Honest About Yourself</p>
        </div>
      </div>
    </body>
    </html>
  ...
  return sendEmail({
    to: userEmail,
    subject: `Welcome to SheMax ${tier} - Subscription Confirmed`,
    html,
  });
}
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Want to make changes? <a href="https://shemax.app/settings" class="cta">Manage Subscription</a></p>
        </div>
        <div class="footer">
          <p>SheMax - Be Honest About Yourself</p>
          <p><a href="https://shemax.app/unsubscribe">Unsubscribe from emails</a></p>
        </div>
      </div>
    </body>
    </html>
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Please update your payment method to continue enjoying SheMax.</p>
          <p><a href="https://shemax.app/settings" class="cta">Update Payment Method</a></p>
          <p>If you have questions, contact us at support@shemax.app</p>
        </div>
      </div>
    </body>
    </html>
  ...
  const html = `
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <p>Congratulations!</p>
          <p><strong>${referreeName}</strong> just subscribed to SheMax using your referral link!</p>
          <div class="highlight">
          ...
          <p><a href="https://shemax.app/dashboard/affiliate" class="cta">View Your Dashboard</a></p>
        </div>
        <div class="footer">
          <p>SheMax Affiliate Program</p>
        </div>
      </div>
    </body>
    </html>
