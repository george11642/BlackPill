...
export function OnboardingScreen() {
    ...
    try {
      ...
      if (!cameraStatus.granted) {
        showAlert({
          ...
          message: 'SheMax needs camera access to analyze your photos.',
          buttons: [{ text: 'OK' }],
        });
        return false;
      }
  ...
  const completeOnboarding = async (goToCamera: boolean) => {
    ...
    try {
      ...
      if (goToCamera) {
        await AsyncStorage.setItem('@shemax_first_scan_pending', 'true');
      }
      ...
      if (error.status === 401 || (error.message && error.message.includes('Invalid or expired'))) {
        ...
        try {
          ...
          if (goToCamera) {
            await AsyncStorage.removeItem('@shemax_first_scan_pending');
          }
              ...
              <View style={styles.disclaimerInner}>
                ...
                >
                  <Text style={styles.disclaimerText}>
                    SheMax provides AI-powered attractiveness analysis for
        ...
        return (
          ...
          >
            <View style={styles.ratingHeader}>
              ...
              <Text style={styles.stepTitle}>Enjoying SheMax?</Text>
              <Text style={styles.stepSubtitle}>
