...
export function SubscriptionScreen() {
  ...
  const handlePurchase = async () => {
    ...
    try {
      ...
      const referralCode = await AsyncStorage.getItem('@shemax_referral_code');
      const customerInfo = await purchasePackage(pkg, referralCode || undefined);

      // Clear referral code after successful purchase
      if (referralCode) {
        await AsyncStorage.removeItem('@shemax_referral_code');
      }
    ...
    try {
      ...
      if (Platform.OS === 'ios') {
        ...
        if (canOpen) {
          ...
          Alert.alert(
            'Manage Subscription',
            'To manage your subscription:\n\n1. Open Settings\n2. Tap your name at the top\n3. Tap Subscriptions\n4. Find SheMax and manage your subscription',
            [{ text: 'OK' }]
          );
        }
      } else {
        const packageName = 'com.shemax.app';
              ...
              <>
                ...
                <View style={styles.disclosureContainer}>
                  ...
                  <View style={styles.disclosureLinks}>
                    <TouchableOpacity
                      onPress={() => Linking.openURL('https://www.shemax.app/privacy')}
                    ...
                    <TouchableOpacity
                      onPress={() => Linking.openURL('https://www.shemax.app/terms')}
                      style={styles.disclosureLink}
                    >
