...
export const getSubscriptionTier = (customerInfo: CustomerInfo | null): 'premium' | null => {
  ...
  if (
    ...
    activeEntitlements['SheMax Premium'] ||
    activeEntitlements['SheMax_Premium']
  ) {
    return 'premium';
  }
  ...
  if (
    ...
    activeEntitlements['SheMax Elite'] ||
    activeEntitlements['SheMax_Elite'] ||
    activeEntitlements['SheMax Pro'] ||
