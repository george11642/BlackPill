          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-8 hover:border-yellow-500/50 transition">
              ...
              <div className="space-y-2">
                <a href="/shemax/privacy" className="text-yellow-500 hover:text-yellow-400 font-medium block">
                  Privacy Policy
                </a>
                <a href="/shemax/terms" className="text-yellow-500 hover:text-yellow-400 font-medium block">
                  Terms of Service
                </a>
              </div>
            </div>
