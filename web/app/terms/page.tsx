    ...
    <>
      ...
      <Section title="Terms of Service" subtitle="Last Updated: November 29, 2025">
        <div className="prose max-w-4xl mx-auto text-secondary">
          ...
          <p>
            By accessing or using the BlackPill application and website, you agree to be bound by these Terms of Service. 
            If you do not agree to these terms, please do not use our services.
          </p>

          <h3>2. Description of Service</h3>
          <p>
            BlackPill provides AI-powered attractiveness analysis and self-improvement tips. 
          ...
          <p>
            In no event shall BlackPill be liable for any indirect, incidental, special, consequential, or punitive damages arising out of your use of the service.
          </p>
          ...
          <h3>8. Contact</h3>
          <p>
            Questions about the Terms of Service should be sent to support@black-pill.app.
          </p>
        </div>
      </Section>
