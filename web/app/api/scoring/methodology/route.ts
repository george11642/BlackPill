...
const METHODOLOGY = {
  ...
  disclaimers: {
    algorithmic:
      'Scores are algorithmic estimates based on conventional beauty standards, not absolute truth.',
    scientific:
      'Our methodology is based on peer-reviewed research, but beauty is subjective and culturally influenced.',
