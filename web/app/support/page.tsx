...
const SupportPage = () => {
  ...
  const faqs = [
    {
      question: 'What is BlackPill?',
      answer: 'BlackPill is an AI-powered attractiveness analysis app that provides facial analysis, transformation simulations, AI coaching, and beauty tracking. It\'s designed for self-improvement and confidence building through data-driven insights.',
    },
    {
      question: 'How does the AI analysis work?',
      answer: 'Our AI uses advanced computer vision technology to analyze facial features and provide a comprehensive attractiveness score. The analysis considers facial symmetry, skin quality, features, and other factors. Results are for informational and entertainment purposes.',
    },
    {
    ...
    },
    {
      ...
      answer: 'BlackPill is available on iOS and Android through the app stores. A web version is also available for some features.',
    },
    {
    ...
    {
      question: 'How accurate is the attractiveness score?',
    ...
    },
    {
      ...
      answer: 'BlackPill should only be used with photos of yourself. Using photos of others without consent violates our terms of service and may result in account suspension.',
    },
    {
      question: 'Do you have a referral program?',
      answer: 'Yes! Refer friends to BlackPill and earn rewards. You can share your unique referral code through the app or website.',
    },
  ];
      ...
      <section className="py-12 px-4 bg-gray-900/50">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-yellow-900/20 border border-yellow-700/50 rounded-lg p-6 text-sm text-gray-300">
            <p className="mb-3">
              <strong>Medical Disclaimer:</strong> BlackPill provides AI-powered attractiveness analysis for
            ...
            <p className="mb-3">
              ...
              are based on AI analysis and should not be considered definitive assessments of attractiveness or
              self-worth.
            </p>
            <p>
