 ...
 * Grants promotional "Smile Score Pro" entitlement to affiliate brushwithgrace@gmail.com
 * 
 * Usage: npx ts-node web/scripts/grant-affiliate-entitlement.ts
 */
...
const AFFILIATE_EMAIL = 'brushwithgrace@gmail.com';
...
function generateAppUserId(): string {
  const uuid = uuidv4();
  return `affiliate_brushwithgrace_${uuid}`;
}
