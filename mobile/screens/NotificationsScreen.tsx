    ...
    >
      ...
      <Animated.View style={contentAnimatedStyle}>
        <Text style={styles.description}>
          Manage how you receive updates and reminders about your BlackPill journey.
        </Text>
      </Animated.View>
        ...
        <GlassCard variant="subtle">
          <View>
            ...
            <Text style={styles.infoText}>
              To receive push notifications, make sure notifications are enabled in your device settings for the BlackPill app.
            </Text>
          </View>
        </GlassCard>
      </Animated.View>
