...
const QUICK_PROMPTS = [
  { icon: '💪', label: 'Improve jawline', prompt: 'What exercises and habits can help me develop a more defined jawline?' },
  { icon: '✨', label: 'Clear skin', prompt: 'Give me a complete skincare routine for clearer, healthier skin.' },
  { icon: '💇', label: 'Hair advice', prompt: 'What hairstyle would best suit my face shape and how do I maintain it?' },
  { icon: '🏋️', label: 'Face gains', prompt: 'How can losing body fat improve my facial aesthetics?' },
  { icon: '😴', label: 'Mewing guide', prompt: 'Explain proper mewing technique and how long until I see results.' },
  { icon: '🧴', label: 'Anti-aging', prompt: 'What preventive measures can I take now to maintain youthful appearance?' },
];
    ...
    if (
      ...
      if (params.tip && params.tipDescription) {
        ...
        const metricLabels: Record<string, string> = {
          masculinity: 'facial masculinity and structure',
